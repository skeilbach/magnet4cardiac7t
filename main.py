...
from src.optimizers import DummyOptimizer, OurOptimizer
from src.data import Simulation, CoilConfig, SimulationTorch, CoilConfigTorch
...
def run(simulation: Simulation | SimulationTorch,
        cost_function: BaseCost,
        timeout: int = 300) -> CoilConfig | CoilConfigTorch:
    """
...
if __name__ == "__main__":
    # Example usage
    simulation = SimulationTorch(path="data/simulations/children_1_tubes_6_id_23713.h5", sparse_sampling=True)
